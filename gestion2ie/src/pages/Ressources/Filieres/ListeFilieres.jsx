...
function ListeFilieres({ refreshKey }) {
  ...
  <div className="card-body p-4">
    ...
    <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
      <div>
        ...
        <div className="d-flex align-items-center justify-content-center rounded-3"
          ...
          Liste des filières enregistrées
        </h4>
    ...
    {!loading && !error && items.length === 0 && (
      <div className="text-center py-5">
        ...
        <h5 className="fw-bold text-dark">Aucune filière enregistrée</h5>
        <p className="text-muted mb-0">Ajoutez une nouvelle filière pour commencer.</p>
      </div>
    )}
    ...
    {!loading && !error && items.length > 0 && (
      <div className="table-responsive">
        <table className="table align-middle mb-0"
            ...
            <tr>
             <th className="border-0 text-uppercase  fw-semibold px-3 text-white"
              ...
              <th className="border-0 text-uppercase fw-semibold text-white"
                                style={{ fontSize: "0.8rem" }}> Description
                            </th>
              <th className="border-0 text-uppercase fw-semibold text-white"
          ...
          <tbody>
            {items.map((f) => (
              <tr key={f.id} style={{background: "#f8fafc", borderRadius: "16px", transition: "0.3s ease",}}
        className="shadow-sm">
