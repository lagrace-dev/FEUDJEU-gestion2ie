...
import ListeDecisions from "./Decisions/ListeDecisions";
import DecisionService from "../../service/DecisionService";

const initialState = { libelle: "", description: "" };
...
export default function Decisions() {
    ...
    const handleSubmit = async (e) => {
        ...
        setError(null);
        try {
            await DecisionService.create(values);
  ...
  <>
    <div className="d-flex justify-content-between align-items-center mb-4" style={{ boxShadow: "0 8px 30px rgba(15, 23, 42, 0.2)", padding: "20px", borderRadius: "8px"    }}>
      <div>
        ...
        <p className="text-muted mb-0">Gestion des décisions</p>
      </div>
      <button 
      ...
      >
        ...
        {showForm ? "Fermer" : "Nouvelle décision"}
      </button>
    </div>
    ...
    <ListeDecisions refreshKey={refreshKey} />
        </>
    );
}
