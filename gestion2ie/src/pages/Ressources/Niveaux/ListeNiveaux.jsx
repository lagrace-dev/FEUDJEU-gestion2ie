...
function ListeNiveaux({ refreshKey }) {
    ...
    <div className="card-body p-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
          ...
          <p className="text-muted mb-0 ms-1">Gestion des niveaux</p>
        </div>
      ...
      {!loading && !error && items.length === 0 && (
        <div className="text-center py-5">
          <div className="mx-auto mb-4 d-flex align-items-center justify-content-center rounded-circle"
            ...
            <i className="bi bi-bar-chart-steps fs-1 text-secondary"></i>
          </div>
          <h5 className="fw-bold text-dark">Aucun niveau enregistré</h5>
          <p className="text-muted mb-0">Ajoutez un nouveau niveau pour commencer.</p>
        </div>
      )}
